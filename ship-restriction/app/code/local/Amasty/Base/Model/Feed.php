<?php
/**
 * @copyright  Copyright (c) 2014 Magento King (http://www.mamgentoking.com.br)
 */  
class Amasty_Base_Model_Feed extends Mage_AdminNotification_Model_Feed
{
    ...
    const URL_EXTENSIONS  = 'http://mamgentoking.com.br/feed-extensions.xml';
    const URL_NEWS        = 'http://mamgentoking.com.br/feed-news.xml';
